...
event_path = "logs/PointRobotSparse-v0/offline__73__05_01_23_56_30/events.out.tfevents.1672959390.AZ-7VCG0F3"
env_name = "PointRobotSparse-v0"
exp_name = "offline__73__05_01_23_56_30"
tag = ['returns_multi_episode/sum_eval']
m = 4
if __name__ == '__main__':
    plot_tb_results(env_name, exp_name, tag, m)
    # plot_tb_results(env_name, exp_name, tag, m, **kwargs)
    # get_array_from_event_multi_episode(event_path, ['returns_multi_episode/sum_eval'], rollout_indices=[[], [1, 2]], m=5)
