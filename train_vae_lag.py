...
from models.vae_lag import VAE
    ...
    for iter_ in range(args.num_iters):
        ...
        for i in range(n_batches):
            ...
            for j in range(n_task_batches):  # run over tasks
                ...
                sub_iter = 1
                while sub_iter < vae.encoder_iters:
                    vae.enc_optimizer.zero_grad()
                    vae.dec_optimizer.zero_grad()
