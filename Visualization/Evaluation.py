...
from parallel_envs import make_vec_envs
# from utils import helpers as utl
import ipdb
from Visualization import helpers as utl
    ...
    for episode_idx in range(num_episodes):
        ...
        for step_idx in range(num_steps):
            ...
            with torch.no_grad():
                ...
                # print('Latent: {}'.format(latent.dim()))
                augmented_obs = torch.cat((state, latent), dim=-1)
...
def visualise_behaviour(args,
    ...
    env = make_vec_envs(env_name=args.env_name,
                        ...
                        normalise_rew=False, ret_rms=ret_rms,
